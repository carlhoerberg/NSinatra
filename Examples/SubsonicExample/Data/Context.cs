...
{
    public partial class AddressbookDB : IQuerySurface
    {
        ...
        public AddressbookDB() 
        {
            if (DefaultDataProvider == null) {
                DataProvider = ProviderFactory.GetProvider("SubsonicExample");
            }
            else {
        ...
        public AddressbookDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public AddressbookDB(string connectionString, string providerName)
        {
